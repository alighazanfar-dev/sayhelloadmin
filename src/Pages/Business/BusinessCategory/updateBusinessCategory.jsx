...
const UpdateBusinessCategory = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Update Business Category - Sayhello</title>
      </Helmet>
            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  <h4 className="mb-0">Business Category </h4>
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      <li className="breadcrumb-item">
                        <Link to="/dashboard">Dashboard</Link>
                      </li>
                      <li className="breadcrumb-item active">Update Business Category</li>
                    </ol>
                  </div>
                </div>
              </div>
                        ...
                        <div className="col-md-12">
                          <Select
                            value={category.filter(
                              (cat) => cat.value == businesscategory
                            )}
                            options={category}
                            styles={SelectStyle}
...
export default UpdateBusinessCategory;
