...
const EditBusinessCategory = () => {
  ...
  const handelEditPost = (e) => {
    ...
    BusinessCategoryServices.updateBusinessCategory(id, body)
      .then((res) => navigate("/dashboard/businesscategories"))
  ...
  return (
    <>
      <Helmet>
        <title>Edit Business Category - Emberace</title>
      </Helmet>
                ...
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      ...
                      <li className="breadcrumb-item active">Edit Business Category</li>
                    </ol>
                  </div>
                </div>
              </div>
