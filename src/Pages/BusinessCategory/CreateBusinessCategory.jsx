...
//   };
  ...
  const handelCreatePost = (e) => {
    ...
    BusinessCategoryServices.createBusinessCategory(body)
      .then((res) => {
        navigate("/dahsboard/businesscategories");
        setName("");
  ...
  return (
    <>
      <Helmet>
        <title>Create Business Catgory - Emberace</title>
      </Helmet>
                ...
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      ...
                      <li className="breadcrumb-item active">Create Business Category</li>
                    </ol>
                  </div>
                </div>
              </div>
