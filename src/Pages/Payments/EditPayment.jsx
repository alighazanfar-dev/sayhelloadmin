...
const EditPayment = () => {
  ...
  const handelEditPost = (e) => {
    ...
    PaymentServices.updatePayment(id, body)
      .then((res) => navigate("/dashboard/payments"))
  ...
  return (
    <>
      <Helmet>
        <title>Edit Payment - Emberace</title>
      </Helmet>
                ...
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      ...
                      <li className="breadcrumb-item active">Edit Payment</li>
                    </ol>
                  </div>
                </div>
              </div>
