...
const EditSocial = () => {
  ...
  const handelEditPost = (e) => {
    ...
    SocialServices.updateSocialLink(id, body)
      .then((res) => navigate("/dashboard/socials"))
  ...
  return (
    <>
      <Helmet>
        <title>Edit Social - Emberace</title>
      </Helmet>
                ...
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  ...
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      ...
                      <li className="breadcrumb-item active">Edit Social</li>
                    </ol>
                  </div>
                </div>
              </div>
